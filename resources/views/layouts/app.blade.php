            ...
            <div class="container">
                <div class="row gy-4 justify-content-between">
                    ...
                    <div class="col-lg-6  d-flex flex-column justify-content-center" data-aos="fade-in">
                        <h1><br>Informasi Posyandu<span> Kelurahan Cipawitra</span></h1>
                        <p>Di wilayah Kelurahan Cipawitra, terdapat total 13 Posyandu yang tersebar di berbagai titik,
                            yang berperan penting dalam memberikan layanan kesehatan. </p>
                        {{-- <div class="d-flex">
