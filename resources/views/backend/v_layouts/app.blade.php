    ...
    <div id="main-wrapper">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="p-t-30">
                        ...
                        <!-- Tambahkan menu Jadwal Kegiatan -->
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="{{ route('backend.jadwal.index') }}" aria-expanded="false">
                                <i class="mdi mdi-calendar-check"></i><span class="hide-menu">Jadwal Kegiatan</span>
                            </a>
                        </li>

                        <!-- Tambahkan menu Dokumentasi -->
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="{{route('backend.dokumentasi.index')}}" aria-expanded="false">
                                <i class="mdi mdi-folder"></i><span class="hide-menu">Dokumentasi</span>
                            </a>
                        </li>
        ...
        <div class="page-wrapper">
            ...
            <footer class="footer text-center">
                <p>&copy; 2024 Cipitra. Semua hak cipta dilindungi.</p>
            </footer>
            <!-- ============================================================== -->
            <!-- End footer -->
            <!-- ============================================================== -->
