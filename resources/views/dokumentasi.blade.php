...
<head>
  ...
  * License: https://bootstrapmade.com/license/
  ======================================================== -->
  <style>
    /* Mengatur grid untuk galeri */
    .gallery-item img {
    width: 100%;  /* Membuat gambar lebar 100% dari container */
    height: 200px; /* Menentukan tinggi gambar yang seragam */
    object-fit: cover; /* Memastikan gambar tetap terpotong dan terjaga proporsinya */
}
        ...
        <section id="hero" class="hero section dark-background">
            ...
            <div class="container d-flex justify-content-start align-items-center"
                ...
                <div class="col-lg-6 d-flex flex-column justify-content-center" data-aos="fade-in">
                    <h1>Halaman Informasi Mengenai Dokumentasi Kegiatan di Posyandu Kelurahan Cipawitra</h1>
                    <p>Di halaman ini, Anda dapat menemukan informasi seputar Dokumentasi Kegiatan yang ada di Posyandu
                ...
                <div class="row g-0">
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="gallery-item">
                            <a href="{{ asset('storage/' . $item->file) }}" class="glightbox" data-gallery="images-gallery" data-title="{{ $item->deskripsi }}">
                                <img src="{{ asset('storage/' . $item->file) }}" alt="Dokumentasi Kegiatan" class="img-fluid">
